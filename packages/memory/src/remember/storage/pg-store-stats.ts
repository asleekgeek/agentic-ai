...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:17-18
// 0.05 = minimum heat threshold for active vs archived classification
const HEAT_ACTIVE_THRESHOLD = 0.05; // source: cortex main mcp_server/infrastructure/pg_store_stats.py:17

// source: cortex main mcp_server/infrastructure/pg_store_stats.py:21-33
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:35-39
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:41-46
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:50-55
// eslint-disable-next-line @typescript-eslint/no-magic-numbers -- source: cortex main mcp_server/infrastructure/pg_store_stats.py:51
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:57-65
// eslint-disable-next-line @typescript-eslint/no-magic-numbers -- source: cortex main mcp_server/infrastructure/pg_store_stats.py:58
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:69-83
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:85-107
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:109-117
export async function getMemoriesByStage(
  client: PoolClient, stage: string,
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:110
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:119-124
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:126-131
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:151-161
// eslint-disable-next-line @typescript-eslint/no-magic-numbers -- source: cortex main mcp_server/infrastructure/pg_store_stats.py:152
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:163-180
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:184-201
export async function getEpisodicMemories(
  client: PoolClient, domain = "", directory = "",
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:185
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:203-219
export async function getSemanticMemories(
  client: PoolClient, domain = "",
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:204
  limit = 500, // eslint-disable-line @typescript-eslint/no-magic-numbers
): Promise<Record<string, unknown>[]> {
  if (domain) {
    return (await client.query(
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:221-226
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:230-243
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:245-249
...
// source: cortex main mcp_server/infrastructure/pg_store_stats.py:251-256
