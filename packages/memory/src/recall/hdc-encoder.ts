 ...
 *
 * Port of: cortex main mcp_server/core/hdc_encoder.py
 */
 ...
 *         cortex main mcp_server/core/hdc_encoder.py:27
 */
export const HDC_DIM = 1024; // source: Kanerva (2009) "Hyperdimensional Computing", §3; cortex main mcp_server/core/hdc_encoder.py:27

/**
 * Random-projection seed for reproducibility across processes.
 * source: cortex main mcp_server/core/hdc_encoder.py:30
 */
const _SEED = 0xdeadbeef; // source: cortex main mcp_server/core/hdc_encoder.py:30 (reproducibility seed for tiebreak vector)
...
//         cortex main mcp_server/core/hdc_encoder.py:43-48
...
// source: cortex main mcp_server/core/hdc_encoder.py:43-44 (mod 2^32 seed from hash bytes)
...
const HASH_BYTE3_INDEX = 3; // source: cortex main mcp_server/core/hdc_encoder.py:44 (4th byte of SHA-256 digest)
...
// source: cortex main mcp_server/core/hdc_encoder.py:171 (len(w) > 1)
const MIN_WORD_LEN = 1; // used as: word.length > MIN_WORD_LEN (i.e. > 1 → length >= 2)

// Default similarity threshold for HDC scores.
// source: cortex main mcp_server/core/hdc_encoder.py:224
 ...
 * source: cortex main mcp_server/core/hdc_encoder.py:114-153
 */
 ...
 *
 * source: cortex main mcp_server/core/hdc_encoder.py:36-49
 */
function wordToHdc(word: string, dim: number = HDC_DIM): Float32Array {
  // SHA-256 of word → 32-bit seed (mod 2^32)
  // source: cortex main mcp_server/core/hdc_encoder.py:43-44 (double-hash seed method)
 ...
 *         cortex main mcp_server/core/hdc_encoder.py:55-61
 */
 ...
 *
 * source: Kanerva (2009) §2.3;
 *         cortex main mcp_server/core/hdc_encoder.py:64-88
 */
 ...
 *
 * source: Kanerva (2009) §2.3;
 *         cortex main mcp_server/core/hdc_encoder.py:91-97
 */
 ...
 *         cortex main mcp_server/core/hdc_encoder.py:100-108
 */
 ...
 *
 * source: cortex main mcp_server/core/hdc_encoder.py:156-190
 */
 ...
 *
 * source: cortex main mcp_server/core/hdc_encoder.py:193-203
 */
 ...
 *
 * source: cortex main mcp_server/core/hdc_encoder.py:209-245
 *
 * @param threshold - Minimum similarity to include in results (default 0.05).
 *                    source: cortex main hdc_encoder.py:224
 */
