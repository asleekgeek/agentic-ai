 ...
 *
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py
 *
...
// ── Tier Classification ───────────────────────────────────────────────────
// source: cortex main mcp_server/core/retrieval_dispatch.py:28-40
 ...
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:38-43
 */
 ...
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:47-57
 *
...
export function wrfFuse(
  ...
  k = 60, // source: cortex main mcp_server/core/retrieval_dispatch.py:53 — RRF k=60 (Cormack 2009)
): Array<[number, number]> {
 ...
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:73-83
 */
function baseWeights(
  ...
  return {
    ...
    fts: f,
    heat: h,
    hopfield: v * 0.5,  // source: cortex main mcp_server/core/retrieval_dispatch.py:78
    hdc: v * 0.4,       // source: cortex main mcp_server/core/retrieval_dispatch.py:79
    sr: h * 0.6,        // source: cortex main mcp_server/core/retrieval_dispatch.py:80
    sa,
    bm25: f * 0.8,      // source: cortex main mcp_server/core/retrieval_dispatch.py:82
    ngram: f * 0.6,     // source: cortex main mcp_server/core/retrieval_dispatch.py:83
  };
}

/**
 * BM25-primary weights for entity/factual queries.
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:86-96
 */
function deepWeights(
  ...
  return {
    vector: v * 0.7,    // source: cortex main mcp_server/core/retrieval_dispatch.py:88
    fts: f * 1.2,       // source: cortex main mcp_server/core/retrieval_dispatch.py:89
    heat: h * 0.5,      // source: cortex main mcp_server/core/retrieval_dispatch.py:90
    hopfield: v * 0.3,  // source: cortex main mcp_server/core/retrieval_dispatch.py:91
    hdc: v * 0.2,       // source: cortex main mcp_server/core/retrieval_dispatch.py:92
    sr: h * 0.3,        // source: cortex main mcp_server/core/retrieval_dispatch.py:93
    sa: sa * 1.5,       // source: cortex main mcp_server/core/retrieval_dispatch.py:94
    bm25: f * 1.5,      // source: cortex main mcp_server/core/retrieval_dispatch.py:95
    ngram: f * 1.0,     // source: cortex main mcp_server/core/retrieval_dispatch.py:96
  };
}

/**
 * Balanced weights for multi-hop queries.
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:99-109
 */
function mixedWeights(
  ...
  return {
    ...
    fts: f,
    heat: h,
    hopfield: v * 0.5,   // source: cortex main mcp_server/core/retrieval_dispatch.py:104
    hdc: v * 0.4,        // source: cortex main mcp_server/core/retrieval_dispatch.py:105
    sr: h * 0.6,         // source: cortex main mcp_server/core/retrieval_dispatch.py:106
    sa: sa * 1.2,        // source: cortex main mcp_server/core/retrieval_dispatch.py:107
    bm25: f * 0.8,       // source: cortex main mcp_server/core/retrieval_dispatch.py:108
    ngram: f * 0.6,      // source: cortex main mcp_server/core/retrieval_dispatch.py:109
  };
}
 ...
 *
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:112-125
 *
...
function instructionWeights(
  ...
  return {
    vector: v * 0.5,   // source: cortex main mcp_server/core/retrieval_dispatch.py:117
    fts: f * 1.5,      // source: cortex main mcp_server/core/retrieval_dispatch.py:118
    heat: h * 0.5,     // source: cortex main mcp_server/core/retrieval_dispatch.py:119
    hopfield: v * 0.2, // source: cortex main mcp_server/core/retrieval_dispatch.py:120
    hdc: v * 0.2,      // source: cortex main mcp_server/core/retrieval_dispatch.py:121
    sr: h * 0.3,       // source: cortex main mcp_server/core/retrieval_dispatch.py:122
    sa: sa * 0.5,      // source: cortex main mcp_server/core/retrieval_dispatch.py:123
    bm25: f * 2.0,     // source: cortex main mcp_server/core/retrieval_dispatch.py:124
    ngram: f * 1.2,    // source: cortex main mcp_server/core/retrieval_dispatch.py:125
  };
}
 ...
 *
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:128-144
 *
...
export function computeSignalWeights(
  ...
  baseVector = 1.0,  // source: cortex main mcp_server/core/retrieval_dispatch.py:131
  baseFts = 0.5,     // source: cortex main mcp_server/core/retrieval_dispatch.py:132
  baseHeat = 0.3,    // source: cortex main mcp_server/core/retrieval_dispatch.py:133
  intent?: string,
): Record<string, number> {
 ...
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:149-157
 *
...
export function mergeMultihopResults(
  ...
  hopWeight = 0.3, // source: cortex main mcp_server/core/retrieval_dispatch.py:150
): Array<[number, number]> {
 ...
 *
 * Port of: cortex main mcp_server/core/retrieval_dispatch.py:172-197
 *
...
export async function dispatchRetrieval({
  ...
  intentInfo,
  contentLookup,
  wrrfK = 60,       // source: cortex main mcp_server/core/retrieval_dispatch.py:174 — Cormack 2009
  baseVectorW = 1.0,
  baseFtsW = 0.5,
  baseHeatW = 0.3,
  maxResults = 10,
