 ...
 *
 * Port of: cortex main mcp_server/core/sensory_buffer.py
 *
 * Sources:
 ...
 *
 * source: cortex main mcp_server/core/sensory_buffer.py:29-54
 */
...
// source: cortex main mcp_server/core/thermodynamics.py — importance heuristics
...
// source: cortex main mcp_server/core/thermodynamics.py — valence heuristics
...
// source: cortex main mcp_server/core/sensory_buffer.py — push(), stats()
const ROUND_PRECISION = 1e4;

// Default buffer capacity and urgency threshold.
// source: cortex main mcp_server/core/sensory_buffer.py:76-77
//   capacity: int = 50
...
// Default peek window.
// source: cortex main mcp_server/core/sensory_buffer.py:130 — peek(self, n: int = 5)
...
// source: cortex main mcp_server/core/sensory_buffer.py:138
...
// source: cortex main mcp_server/core/sensory_buffer.py:210 — round(..., 1)
 ...
 *
 * source: cortex main mcp_server/core/sensory_buffer.py:59-219
 */
export class SensoryBuffer {
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:74-82
   *   capacity default = 50
   ...
   * source: cortex main mcp_server/core/sensory_buffer.py:86-90
   */
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:92-126
   */
  push(
    content: string,
    opts: {
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:130-133
   */
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:135-140
   */
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:144-175
   */
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:177-181
   */
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:183-187
   */
  drainAll(): BufferItem[] {
   ...
   *
   * source: cortex main mcp_server/core/sensory_buffer.py:203-219
   */
...
//
// source: cortex main mcp_server/core/sensory_buffer.py:222-245
 ...
 *
 * source: cortex main mcp_server/core/sensory_buffer.py:229-239
 */
 ...
 *
 * source: cortex main mcp_server/core/sensory_buffer.py:242-245
 */
